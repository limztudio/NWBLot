...
TEST_F(DescriptorBufferRoundTripTest, GraphOwnedUnsplitAvboitExtinctionSharedOutputRegularQuadruplesStayInPrePacket){
    ...
    auto depthWarp = createWorkBuffer(
        Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_quad_depth_warp")
    );
    auto control = createWorkBuffer(
        Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_quad_control")
    );
    auto materialStream = createWorkBuffer(
        Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_quad_material_stream")
    );
    auto generatedVertex = createWorkBuffer(
        Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_quad_generated_vertex"),
        true
    );
    ...
    auto extinction = createWorkBuffer(
        Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_quad_extinction")
    );
    auto extinctionOverflow = createWorkBuffer(
        Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_quad_overflow")
    );
    auto transmittance = createWorkBuffer(
        Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_quad_transmittance")
    );
    ASSERT_TRUE(
        stateProbe
        && coverage
    ...
    const GpuGraphResourceId lowRasterResource = importTexture(
        lowRaster,
        Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_quad_low_raster"),
        "AVBOIT Low Raster"
    );
    ...
    const GpuTaskId preTask = graph.addTask<NativePacketAsyncAvboitExtinctionLifecycleTask>(
        GpuTaskDesc{}
            .setIdentity(Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_quad_pre_task"))
    ...
    const GpuTaskId occupancyTask = graph.addTask<NativePacketAsyncAvboitExtinctionLifecycleTask>(
        GpuTaskDesc{}
            .setIdentity(Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_quad_occupancy_task"))
    ...
    const GpuTaskId depthWarpTask = graph.addTask<NativePacketAsyncAvboitExtinctionLifecycleTask>(
        GpuTaskDesc{}
            .setIdentity(Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_quad_depth_warp_task"))
    ...
    const GpuTaskId streamTask = graph.addTask<NativePacketAsyncAvboitExtinctionLifecycleTask>(
        GpuTaskDesc{}
            .setIdentity(Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_quad_material_upload_task"))
    ...
    const Name sharedPhaseIdentities[] = {
        Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_quad_dispatch_a_task"),
        Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_quad_raster_a_task"),
        Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_quad_dispatch_b_task"),
        Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_quad_raster_b_task"),
        Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_quad_dispatch_c_task"),
        Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_quad_raster_c_task"),
        Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_quad_dispatch_d_task"),
        Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_quad_raster_d_task"),
    };
    ...
    integrationPayload.expectedOrdinal = 12u;
    ...
    const GpuTaskId integrationTask = graph.addTask<NativePacketAsyncAvboitExtinctionLifecycleTask>(
        GpuTaskDesc{}
            .setIdentity(Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_quad_integration_task"))
    ...
    const GpuTaskId accumulationTask = graph.addTask<NativePacketAsyncAvboitExtinctionLifecycleTask>(
        GpuTaskDesc{}
            .setIdentity(Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_quad_accumulation_task"))
    ...
    Alloc::ScratchArena scratchArena(Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_quad_scratch"));
    ...
    EXPECT_TRUE(analysis.hasExplicitEdge(rasterDTask, integrationTask));
    ...
    EXPECT_TRUE(analysis.hasInferredEdge(rasterDTask, integrationTask));
    ...
    EXPECT_TRUE(hasBufferUav(rasterDTask, extinctionResource));
    EXPECT_TRUE(hasBufferUav(rasterDTask, extinctionOverflowResource));
    EXPECT_TRUE(hasBufferTransition(
        integrationTask,
        extinctionResource,
        ResourceStates::UnorderedAccess,
    ...
    EXPECT_TRUE(sharedPhaseRecorded[6u]);
    EXPECT_TRUE(sharedPhaseRecorded[7u]);
