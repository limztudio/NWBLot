...
// Three regular Occupancy draws reuse one retained generated-vertex output only when every dispatch is consumed
// before the next overwrite. Exercise Pre -> stream -> typed clear -> D(A) -> R(A) -> D(B) -> R(B) -> D(C) ->
// R(C) -> packet-local Depth Warp in one accepting Graphics packet under Pre's shared timing ticket.
TEST_F(DescriptorBufferRoundTripTest, GraphOwnedUnsplitAvboitOccupancySharedOutputComputeEmulationTriplesStayInPrePacket){
    ...
    auto coverage = createWorkBuffer(
        Name("tests/descriptor_buffer/unsplit_avboit_occupancy_shared_output_triple_coverage")
    );
    auto depthWarp = createWorkBuffer(
        Name("tests/descriptor_buffer/unsplit_avboit_occupancy_shared_output_triple_depth_warp")
    );
    auto generatedVertex = createWorkBuffer(
        Name("tests/descriptor_buffer/unsplit_avboit_occupancy_shared_output_triple_generated_vertex"),
        true
    );
    ...
    const GpuTaskId preTask = graph.addTask<NativePacketAsyncAvboitExtinctionLifecycleTask>(
        GpuTaskDesc{}
            .setIdentity(Name("tests/descriptor_buffer/unsplit_avboit_occupancy_shared_output_triple_pre_task"))
    ...
    const GpuTaskId streamTask = graph.addTask<NativePacketAsyncAvboitExtinctionLifecycleTask>(
        GpuTaskDesc{}
            .setIdentity(Name("tests/descriptor_buffer/unsplit_avboit_occupancy_shared_output_triple_material_upload_task"))
    ...
    const GpuTaskId clearTask = graph.addTask<NativePacketAsyncAvboitExtinctionLifecycleTask>(
        GpuTaskDesc{}
            .setIdentity(Name("tests/descriptor_buffer/unsplit_avboit_occupancy_shared_output_triple_clear_task"))
    ...
    const Name sharedPhaseIdentities[] = {
        Name("tests/descriptor_buffer/unsplit_avboit_occupancy_shared_output_triple_dispatch_a_task"),
        Name("tests/descriptor_buffer/unsplit_avboit_occupancy_shared_output_triple_raster_a_task"),
        Name("tests/descriptor_buffer/unsplit_avboit_occupancy_shared_output_triple_dispatch_b_task"),
        Name("tests/descriptor_buffer/unsplit_avboit_occupancy_shared_output_triple_raster_b_task"),
        Name("tests/descriptor_buffer/unsplit_avboit_occupancy_shared_output_triple_dispatch_c_task"),
        Name("tests/descriptor_buffer/unsplit_avboit_occupancy_shared_output_triple_raster_c_task"),
    };
    ...
    const GpuTaskId depthWarpTask = graph.addTask<NativePacketAsyncAvboitExtinctionLifecycleTask>(
        GpuTaskDesc{}
            .setIdentity(Name("tests/descriptor_buffer/unsplit_avboit_occupancy_shared_output_triple_depth_warp_task"))
    ...
    Alloc::ScratchArena scratchArena(Name("tests/descriptor_buffer/unsplit_avboit_occupancy_shared_output_triple_lifecycle_scratch"));
    ...
    EXPECT_TRUE(analysis.hasExplicitEdge(rasterCTask, depthWarpTask));
    ...
    EXPECT_TRUE(analysis.hasInferredEdge(rasterCTask, depthWarpTask));
    ...
    EXPECT_EQ(analysis.topologicalOrder()[7u], dispatchCTask);
    EXPECT_EQ(analysis.topologicalOrder()[8u], rasterCTask);
    EXPECT_EQ(analysis.topologicalOrder()[9u], depthWarpTask);
