...
// generated-vertex buffer therefore crosses Common -> UAV -> VertexBuffer -> UAV -> VertexBuffer while Pre, the
// immutable stream, both pairs, and the attachment finalizer remain one accepted primary-Graphics packet.  Every
// callback below is getter-only: state probes, one Pre timing ticket, and accepted-token equality are the contract.
TEST_F(DescriptorBufferRoundTripTest, GraphOwnedUnsplitAvboitAccumulationSharedOutputComputeEmulationPairsStayInPrePacket){
    ...
    auto generatedVertex = createWorkBuffer(
        Name("tests/descriptor_buffer/unsplit_avboit_accumulation_shared_output_generated_vertex"),
        true
    );
    ...
    const GpuGraphResourceId accumColorResource = importTexture(
        accumColor,
        Name("tests/descriptor_buffer/unsplit_avboit_accumulation_shared_output_color"),
        "AVBOIT Accumulation Shared Output Color"
    );
    const GpuGraphResourceId accumExtinctionResource = importTexture(
        accumExtinction,
        Name("tests/descriptor_buffer/unsplit_avboit_accumulation_shared_output_extinction"),
        "AVBOIT Accumulation Shared Output Extinction"
    );
    const GpuGraphResourceId deferredDepthResource = importTexture(
        deferredDepth,
        Name("tests/descriptor_buffer/unsplit_avboit_accumulation_shared_output_depth"),
    ...
    const GpuTaskId preTask = graph.addTask<NativePacketAsyncAvboitExtinctionLifecycleTask>(
        GpuTaskDesc{}
            .setIdentity(Name("tests/descriptor_buffer/unsplit_avboit_accumulation_shared_output_pre_task"))
    ...
    const GpuTaskId streamTask = graph.addTask<NativePacketAsyncAvboitExtinctionLifecycleTask>(
        GpuTaskDesc{}
            .setIdentity(Name("tests/descriptor_buffer/unsplit_avboit_accumulation_shared_output_material_upload_task"))
    ...
    const Name sharedPhaseIdentities[] = {
        Name("tests/descriptor_buffer/unsplit_avboit_accumulation_shared_output_dispatch_a_task"),
        Name("tests/descriptor_buffer/unsplit_avboit_accumulation_shared_output_raster_a_task"),
        Name("tests/descriptor_buffer/unsplit_avboit_accumulation_shared_output_dispatch_b_task"),
        Name("tests/descriptor_buffer/unsplit_avboit_accumulation_shared_output_raster_b_task"),
    };
    ...
    const GpuTaskId finalizerTask = graph.addTask<NativePacketAsyncAvboitExtinctionLifecycleTask>(
        GpuTaskDesc{}
            .setIdentity(Name("tests/descriptor_buffer/unsplit_avboit_accumulation_shared_output_finalize_task"))
    ...
    Alloc::ScratchArena scratchArena(Name("tests/descriptor_buffer/unsplit_avboit_accumulation_shared_output_lifecycle_scratch"));
    ...
    EXPECT_TRUE(analysis.hasExplicitEdge(rasterBTask, finalizerTask));
    ...
    EXPECT_TRUE(analysis.hasInferredEdge(rasterBTask, finalizerTask));
    ...
    EXPECT_EQ(analysis.topologicalOrder()[6u], finalizerTask);
    ...
    // same accepted Graphics token, including both shared-output dispatch/raster pairs and the finalizer.
