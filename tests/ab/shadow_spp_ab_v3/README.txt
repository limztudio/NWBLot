...
-----
  ...
  shots/spp1.png / spp2.png / spp4.png                  1280x900 screenshots per arm (generated by screenshot.py / cook_and_shot.py;
                                                        shadow softness visibly differs). Not committed -- regenerated on demand.
  shots/spp_comparison.png                              labeled side-by-side SPP1|SPP2|SPP4 (with render.frame ms). Generated on demand.
