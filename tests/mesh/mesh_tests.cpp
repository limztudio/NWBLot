...
NWB_DEFINE_TEST_ENTRY_POINT("mesh", [](NWB::Tests::TestContext& context){
    __hidden_mesh_tests::TestMeshClassMetadata(context);
    __hidden_mesh_tests::TestResolvesCoreFrameMath(context);
    __hidden_mesh_tests::TestRebuildsFlatQuadFrame(context);
    __hidden_mesh_tests::TestDegenerateUvsUseStableTangentFallback(context);
    __hidden_mesh_tests::TestRejectsDegenerateTriangle(context);
})
