...
2. **Complete graph ownership.** Renderer code still builds packet ranges, controls recording/submission, and holds
   ...
   and copied rest streams in their declared descriptor-visible states. Its tail meshlet-bounds and repacked-attribute
   outputs transition through a mergeable graph finalizer; only deformation-stream UAV phases and their mid-dispatch
   handoffs remain task-local.
