...
AString BuildMetadata(const TexturePayload& payload, const Path& dataPath, const bool srgb){
    ...
    const bool isLegacy2D = payload.dimension == TextureDimension::Texture2D && payload.depth == 1u;
    ...
    output
        ...
        << s_NewLine
        << "asset.version = " << (isLegacy2D ? 1u : 2u) << ";" << s_NewLine
    ...
    output
        ...
        << "asset.payload_layout = \"" << (isLegacy2D ? "mip_major_blocks" : "mip_major_slice_major_blocks") << "\";" << s_NewLine
