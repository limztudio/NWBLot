...
// the same sequence the monolith did (opaque prepass OR adaptive-opaque coarse+resolve; the soft directional half-res
// trace; then the transparent coarse + either the Stage-3 compacted classify/build-args/indirect chain, the Stage-2
...
inline constexpr Name s_SwSoftDirectionalShaderName("engine/graphics/shadow/sw_shadow_soft_directional_cs");
