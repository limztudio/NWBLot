...
#include <impl/ecs_skinned_geometry/skinned_geometry_runtime_mesh.h>
...
public:
    SkinnedGeometryRuntimeMeshCache(Core::Alloc::CustomArena& arena, Core::Graphics& graphics, Core::Assets::AssetManager& assetManager);
