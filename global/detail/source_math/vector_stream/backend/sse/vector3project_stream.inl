...
[[nodiscard]] inline Vector Vector3ProjectRefinedReciprocalSse(Vector W)noexcept{
...
inline Float3* MathCallConv Vector3ProjectStreamSse
(
            ...
            if(OutputStride == sizeof(Float3)){
                if(!(reinterpret_cast<uintptr_t>(pOutputStream) & 0xF) &&
                    ...
                    if(inputAligned){
                        for(size_t j = 0; j < four; ++j){
                            ...
                            vTemp = _mm_mul_ps(vTemp, Vector3ProjectRefinedReciprocalSse(W));
                            V1 = MATH_FMADD_PS(vTemp, Scale, Offset);
                            ...
                            W = MATH_PERMUTE_PS(vTemp, _MM_SHUFFLE(3, 3, 3, 3));
                            vTemp = _mm_mul_ps(vTemp, Vector3ProjectRefinedReciprocalSse(W));
                            V2 = MATH_FMADD_PS(vTemp, Scale, Offset);
                            ...
                            W = MATH_PERMUTE_PS(vTemp, _MM_SHUFFLE(3, 3, 3, 3));
                            vTemp = _mm_mul_ps(vTemp, Vector3ProjectRefinedReciprocalSse(W));
                            V3 = MATH_FMADD_PS(vTemp, Scale, Offset);
                            ...
                            W = MATH_PERMUTE_PS(vTemp, _MM_SHUFFLE(3, 3, 3, 3));
                            vTemp = _mm_mul_ps(vTemp, Vector3ProjectRefinedReciprocalSse(W));
                            V4 = MATH_FMADD_PS(vTemp, Scale, Offset);
                ...
                if(inputAligned){
                    for(size_t j = 0; j < four; ++j){
                        ...
                        vTemp = _mm_mul_ps(vTemp, Vector3ProjectRefinedReciprocalSse(W));
                        vTemp = MATH_FMADD_PS(vTemp, Scale, Offset);
