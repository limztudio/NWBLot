...
namespace __hidden_renderer_avboit_targets{
...
bool RendererSystem::createAvboitFrameTargets(
    ...
    avboitTargets.lowRasterTarget = __hidden_renderer_avboit_targets::CreateRenderTarget(
        m_graphics,
    ...
    avboitTargets.accumColor = __hidden_renderer_avboit_targets::CreateRenderTarget(
        m_graphics,
    ...
    avboitTargets.accumExtinction = __hidden_renderer_avboit_targets::CreateRenderTarget(
        m_graphics,
        avboitTargets.fullWidth,
        avboitTargets.fullHeight,
    ...
    avboitTargets.coverageBuffer = __hidden_renderer_avboit_targets::CreateU32Buffer(
        m_graphics,
        coverageBytes,
    ...
    avboitTargets.depthWarpBuffer = __hidden_renderer_avboit_targets::CreateU32Buffer(
        m_graphics,
        depthWarpBytes,
    ...
    avboitTargets.controlBuffer = __hidden_renderer_avboit_targets::CreateU32Buffer(
        m_graphics,
    ...
    avboitTargets.extinctionBuffer = __hidden_renderer_avboit_targets::CreateU32Buffer(
        m_graphics,
        extinctionBytes,
    ...
    avboitTargets.extinctionOverflowBuffer = __hidden_renderer_avboit_targets::CreateU32Buffer(
        m_graphics,
    ...
    avboitTargets.transmittanceTexture = __hidden_renderer_avboit_targets::CreateTransmittanceVolume(
        m_graphics,
        avboitTargets.lowWidth,
        avboitTargets.lowHeight,
        avboitTargets.physicalSliceCount,
    ...
    __hidden_renderer_avboit_targets::AddDepthSamplerBindings(
    ...
    if(!__hidden_renderer_avboit_targets::CreateBindingSet(
        *device,
