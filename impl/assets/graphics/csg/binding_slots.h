...
#define NWB_CSG_INTERVAL_BINDING_LINEAR_DEPTH 3
#define NWB_CSG_INTERVAL_BINDING_RECEIVER_EVENT_DEPTH 4
#define NWB_CSG_INTERVAL_BINDING_RECEIVER_EVENT_DATA 5
#define NWB_CSG_INTERVAL_BINDING_RECEIVER_EVENT_COUNT 6
#define NWB_CSG_INTERVAL_BINDING_RECEIVER_EVENT_FLAGS 7
#define NWB_CSG_INTERVAL_BINDING_RECEIVER_SPAN_DEPTH 8
#define NWB_CSG_INTERVAL_BINDING_RECEIVER_SPAN_DATA 9
#define NWB_CSG_INTERVAL_BINDING_RECEIVER_SPAN_COUNT 10
#define NWB_CSG_INTERVAL_BINDING_RECEIVER_SPAN_FLAGS 11
...
#define NWB_CSG_INTERVAL_BINDING_REMOVED_INTERVAL_FLAGS 17
