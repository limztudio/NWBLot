...
void RendererRayTracingState::invalidateResources(){
    ...
    m_giBindingLayout.reset();
    m_giProbeTraceShader.reset();
    m_giProbeTracePipeline.reset();
    m_giProbeBlendIrradianceShader.reset();
    m_giProbeBlendIrradiancePipeline.reset();
    m_giProbeBlendDistanceShader.reset();
    m_giProbeBlendDistancePipeline.reset();
    ...
    m_giBlendDistanceBindingSet.reset();
    m_giBorderIrradianceBindingSet.reset();
    m_giBorderDistanceBindingSet.reset();
    m_giIrradianceAtlasA.reset();
    m_giIrradianceAtlasB.reset();
    m_giDistanceAtlasA.reset();
    m_giDistanceAtlasB.reset();
    m_giRayData.reset();
    m_giProbeData.reset();
    m_giGridConstants.reset();
    m_giHitAlbedo.reset();
    m_giHitAlbedoCapacity = 0u;
    m_giGridSizeX = NWB_GI_DEFAULT_GRID_SIZE_X;
    m_giGridSizeY = NWB_GI_DEFAULT_GRID_SIZE_Y;
    m_giGridSizeZ = NWB_GI_DEFAULT_GRID_SIZE_Z;
    m_giRaysPerProbe = NWB_GI_DEFAULT_RAYS_PER_PROBE;
    m_giHistoryFrontIsA = 1u;
    m_giUpdateCursor = 0u;
    m_giFrameIndex = 0u;
    m_giSeeded = false;
    m_giEnabled = false;
    m_giProbeTracePipelineFailed = false;
    m_giProbeBlendIrradiancePipelineFailed = false;
    m_giProbeBlendDistancePipelineFailed = false;
    m_giProbeBorderPipelineFailed = false;
    m_giDispatchLogged = false;
