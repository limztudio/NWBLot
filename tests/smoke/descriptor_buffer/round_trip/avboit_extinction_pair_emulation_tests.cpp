...
// The regular unsplit Extinction plan may reuse one generated-vertex buffer for exactly two materials.  The complete
// Depth Warp -> stream -> generate/raster A -> generate/raster B -> typed Integration -> Accumulation route must
// remain inside AVBOIT Pre's accepted Graphics packet, including its alternating shared-output barriers and ticket.
TEST_F(DescriptorBufferRoundTripTest, GraphOwnedUnsplitAvboitExtinctionSharedOutputRegularPairsStayInPrePacket){
    ...
    auto depthWarp = createWorkBuffer(
        Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_depth_warp")
    );
    auto control = createWorkBuffer(
        Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_control")
    );
    auto materialStream = createWorkBuffer(
        Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_material_stream")
    );
    auto generatedVertex = createWorkBuffer(
        Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_generated_vertex"),
        true
    );
    ...
    auto extinction = createWorkBuffer(
        Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_extinction")
    );
    auto extinctionOverflow = createWorkBuffer(
        Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_overflow")
    );
    auto transmittance = createWorkBuffer(
        Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_transmittance")
    );
    ASSERT_TRUE(
        stateProbe
        && coverage
    ...
    const GpuGraphResourceId lowRasterResource = importTexture(
        lowRaster,
        Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_low_raster"),
        "AVBOIT Low Raster"
    );
    ...
    const GpuTaskId preTask = graph.addTask<NativePacketAsyncAvboitExtinctionLifecycleTask>(
        GpuTaskDesc{}
            .setIdentity(Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_pre_task"))
    ...
    const GpuTaskId occupancyTask = graph.addTask<NativePacketAsyncAvboitExtinctionLifecycleTask>(
        GpuTaskDesc{}
            .setIdentity(Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_occupancy_task"))
    ...
    const GpuTaskId depthWarpTask = graph.addTask<NativePacketAsyncAvboitExtinctionLifecycleTask>(
        GpuTaskDesc{}
            .setIdentity(Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_depth_warp_task"))
    ...
    const GpuTaskId streamTask = graph.addTask<NativePacketAsyncAvboitExtinctionLifecycleTask>(
        GpuTaskDesc{}
            .setIdentity(Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_material_upload_task"))
    ...
    const Name sharedPhaseIdentities[] = {
        Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_dispatch_a_task"),
        Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_raster_a_task"),
        Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_dispatch_b_task"),
        Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_raster_b_task"),
    };
    ...
    integrationPayload.expectedOrdinal = 8u;
    ...
    const GpuTaskId integrationTask = graph.addTask<NativePacketAsyncAvboitExtinctionLifecycleTask>(
        GpuTaskDesc{}
            .setIdentity(Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_integration_task"))
    ...
    accumulationPayload.expectedOrdinal = 9u;
    ...
    const GpuTaskId accumulationTask = graph.addTask<NativePacketAsyncAvboitExtinctionLifecycleTask>(
        GpuTaskDesc{}
            .setIdentity(Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_accumulation_task"))
    ...
    Alloc::ScratchArena scratchArena(Name("tests/descriptor_buffer/unsplit_avboit_extinction_shared_output_scratch"));
    ...
    EXPECT_TRUE(analysis.hasExplicitEdge(rasterBTask, integrationTask));
    ...
    EXPECT_TRUE(analysis.hasInferredEdge(rasterBTask, integrationTask));
