...
// Indexed compute output appends one uint4; raster and AVBOIT retain their existing push ranges.
#define NWB_MESH_COMPUTE_PUSH_CONSTANT_BYTE_SIZE 80u
#define NWB_MESH_COMPUTE_INDEX_BYTE_OFFSET 64u
#define NWB_MESH_EMULATION_SENTINEL_VERTEX_INDEX 0u
#define NWB_MESH_EMULATION_FIRST_VERTEX_INDEX 1u
