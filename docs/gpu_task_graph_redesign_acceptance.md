...
2. **Complete graph ownership.** Renderer code still builds packet ranges, controls recording/submission, and holds
   ...
   and copied rest streams in their declared descriptor-visible states; only generated-output UAV phases and their
   same-dispatch handoffs remain task-local.
