...
static void TestSceneAndMainCamera(TestContext& context){
    ...
    NWB_SCENE_TEST_CHECK(context, activeCameraEntity.hasComponent<NWB::Core::Scene::ActiveCameraComponent>());
...
static void TestSceneCameraResolution(TestContext& context){
    ...
    NWB::Core::Scene::SceneCameraView invalidRequestedFallbackCameraView = NWB::Core::Scene::ResolveSceneCameraView(testWorld.world);
    ...
    NWB::Core::Scene::SceneCameraView invalidTransformFallbackCameraView = NWB::Core::Scene::ResolveSceneCameraView(testWorld.world);
    ...
    NWB::Core::Scene::SceneCameraView invalidProjectionFallbackCameraView = NWB::Core::Scene::ResolveSceneCameraView(testWorld.world);
    ...
    *secondCamera = NWB::Core::Scene::CameraComponent{};
    ...
    secondCamera->setVerticalFovRadians(179.0f * (s_PI / 180.0f));
    NWB::Core::Scene::SceneCameraView invalidFallbackAspectCameraView = NWB::Core::Scene::ResolveSceneCameraView(testWorld.world, s_MaxF32);
    ...
    *secondCamera = NWB::Core::Scene::CameraComponent{};
    ...
    NWB::Core::Scene::SceneCameraView nonUnitTransformFallbackCameraView = NWB::Core::Scene::ResolveSceneCameraView(testWorld.world);
    ...
    NWB::Core::Scene::SceneCameraView nonFiniteScaleFallbackCameraView = NWB::Core::Scene::ResolveSceneCameraView(testWorld.world);
    ...
    NWB::Core::Scene::SceneCameraView invalidFallbackSkippedCameraView = NWB::Core::Scene::ResolveSceneCameraView(testWorld.world);
