...
inline Vector MathCallConv ConvertVectorIntToFloat
(
    VectorArg    VInt,
...
inline Vector MathCallConv ConvertVectorFloatToInt
(
    VectorArg    VFloat,
    ...
    vResult = vreinterpretq_f32_u32(vandq_u32(vOverflow, g_AbsMask));
...
inline Vector MathCallConv ConvertVectorUIntToFloat
(
    VectorArg     VUInt,
    uint32_t      DivExponent
)noexcept{
...
inline Vector MathCallConv ConvertVectorFloatToUInt
(
    VectorArg     VFloat,
    uint32_t      MulExponent
)noexcept{
...
inline Vector MathCallConv LoadInt(const uint32_t* pSource)noexcept{
    assert(pSource);
#if defined(_MATH_NO_INTRINSICS_)
    Vector V;
...
_Use_decl_annotations_
inline Vector MathCallConv LoadFloat(const float* pSource)noexcept{
    assert(pSource);
#if defined(_MATH_NO_INTRINSICS_)
    Vector V;
...
_Use_decl_annotations_
inline Vector MathCallConv LoadInt2(const uint32_t* pSource)noexcept{
    assert(pSource);
#if defined(_MATH_NO_INTRINSICS_)
    Vector V;
...
_Use_decl_annotations_
inline Vector MathCallConv LoadInt2A(const uint32_t* pSource)noexcept{
    assert(pSource);
...
_Use_decl_annotations_
inline Vector MathCallConv LoadFloat2(const Float2* pSource)noexcept{
    assert(pSource);
#if defined(_MATH_NO_INTRINSICS_)
    Vector V;
...
_Use_decl_annotations_
inline Vector MathCallConv LoadFloat2A(const AlignedFloat2* pSource)noexcept{
    assert(pSource);
    assert((reinterpret_cast<uintptr_t>(pSource) & 0xF) == 0);
#if defined(_MATH_NO_INTRINSICS_)
    Vector V;
...
_Use_decl_annotations_
inline Vector MathCallConv LoadSInt2(const Int2* pSource)noexcept{
    assert(pSource);
#if defined(_MATH_NO_INTRINSICS_)
    Vector V;
...
_Use_decl_annotations_
inline Vector MathCallConv LoadUInt2(const UInt2* pSource)noexcept{
    assert(pSource);
#if defined(_MATH_NO_INTRINSICS_)
    Vector V;
    V.vector4_f32[0] = static_cast<float>(pSource->x);
...
_Use_decl_annotations_
inline Vector MathCallConv LoadInt3(const uint32_t* pSource)noexcept{
    assert(pSource);
#if defined(_MATH_NO_INTRINSICS_)
    Vector V;
    V.vector4_u32[0] = pSource[0];
...
_Use_decl_annotations_
inline Vector MathCallConv LoadInt3A(const uint32_t* pSource)noexcept{
    assert(pSource);
    assert((reinterpret_cast<uintptr_t>(pSource) & 0xF) == 0);
#if defined(_MATH_NO_INTRINSICS_)
    Vector V;
...
_Use_decl_annotations_
inline Vector MathCallConv LoadFloat3(const Float3* pSource)noexcept{
    assert(pSource);
#if defined(_MATH_NO_INTRINSICS_)
    Vector V;
    V.vector4_f32[0] = pSource->x;
...
_Use_decl_annotations_
inline Vector MathCallConv LoadFloat3A(const AlignedFloat3* pSource)noexcept{
    assert(pSource);
    assert((reinterpret_cast<uintptr_t>(pSource) & 0xF) == 0);
#if defined(_MATH_NO_INTRINSICS_)
    Vector V;
...
_Use_decl_annotations_
inline Vector MathCallConv LoadSInt3(const Int3* pSource)noexcept{
    assert(pSource);
#if defined(_MATH_NO_INTRINSICS_)
...
_Use_decl_annotations_
inline Vector MathCallConv LoadUInt3(const UInt3* pSource)noexcept{
    assert(pSource);
#if defined(_MATH_NO_INTRINSICS_)
    Vector V;
    V.vector4_f32[0] = static_cast<float>(pSource->x);
...
_Use_decl_annotations_
inline Vector MathCallConv LoadInt4(const uint32_t* pSource)noexcept{
    assert(pSource);
...
_Use_decl_annotations_
inline Vector MathCallConv LoadInt4A(const uint32_t* pSource)noexcept{
    assert(pSource);
    assert((reinterpret_cast<uintptr_t>(pSource) & 0xF) == 0);
#if defined(_MATH_NO_INTRINSICS_)
    Vector V;
...
_Use_decl_annotations_
inline Vector MathCallConv LoadFloat4(const Float4* pSource)noexcept{
    assert(pSource);
#if defined(_MATH_NO_INTRINSICS_)
    Vector V;
    V.vector4_f32[0] = pSource->x;
...
_Use_decl_annotations_
inline Vector MathCallConv LoadFloat4A(const AlignedFloat4* pSource)noexcept{
    assert(pSource);
    assert((reinterpret_cast<uintptr_t>(pSource) & 0xF) == 0);
#if defined(_MATH_NO_INTRINSICS_)
    Vector V;
...
_Use_decl_annotations_
inline Vector MathCallConv LoadSInt4(const Int4* pSource)noexcept{
    assert(pSource);
#if defined(_MATH_NO_INTRINSICS_)
...
_Use_decl_annotations_
inline Vector MathCallConv LoadUInt4(const UInt4* pSource)noexcept{
    assert(pSource);
#if defined(_MATH_NO_INTRINSICS_)
    Vector V;
    V.vector4_f32[0] = static_cast<float>(pSource->x);
...
_Use_decl_annotations_
inline Matrix MathCallConv LoadFloat3x4(const Float3x4* pSource)noexcept{
    assert(pSource);
    // Float3x4 stores the top three affine rows directly and is the preferred
    // compact boundary format for NWB's column-vector convention.
#if defined(_MATH_NO_INTRINSICS_)
    ...
    Matrix M = {};
    M.r[0] = vreinterpretq_f32_u32(vandq_u32(vreinterpretq_u32_f32(T0), g_Mask3));
    M.r[1] = vreinterpretq_f32_u32(vandq_u32(vreinterpretq_u32_f32(T1), g_Mask3));
    M.r[2] = vreinterpretq_f32_u32(vandq_u32(vreinterpretq_u32_f32(T2), g_Mask3));
...
_Use_decl_annotations_
inline Matrix MathCallConv LoadFloat3x4A(const AlignedFloat3x4* pSource)noexcept{
    assert(pSource);
    assert((reinterpret_cast<uintptr_t>(pSource) & 0xF) == 0);
#if defined(_MATH_NO_INTRINSICS_)
...
_Use_decl_annotations_
inline void MathCallConv StoreInt
(
...
_Use_decl_annotations_
inline void MathCallConv StoreFloat
(
    float* pDestination,
    VectorArg V
)noexcept{
...
_Use_decl_annotations_
inline void MathCallConv StoreInt2
(
    uint32_t* pDestination,
    VectorArg V
)noexcept{
...
_Use_decl_annotations_
inline void MathCallConv StoreInt2A
(
    uint32_t* pDestination,
    VectorArg V
)noexcept{
...
_Use_decl_annotations_
inline void MathCallConv StoreFloat2
(
    Float2* pDestination,
    VectorArg  V
)noexcept{
...
_Use_decl_annotations_
inline void MathCallConv StoreFloat2A
(
    AlignedFloat2* pDestination,
    VectorArg     V
)noexcept{
    assert(pDestination);
    assert((reinterpret_cast<uintptr_t>(pDestination) & 0xF) == 0);
...
_Use_decl_annotations_
inline void MathCallConv StoreSInt2
(
    Int2* pDestination,
    VectorArg V
)noexcept{
...
_Use_decl_annotations_
inline void MathCallConv StoreUInt2
(
    UInt2* pDestination,
    VectorArg V
)noexcept{
...
_Use_decl_annotations_
inline void MathCallConv StoreInt3
(
    uint32_t* pDestination,
    VectorArg V
)noexcept{
...
#elif defined(_MATH_SSE_INTRINSICS_)
    _mm_store_sd(reinterpret_cast<double*>(pDestination), _mm_castps_pd(V));
    __m128 z = MATH_PERMUTE_PS(V, _MM_SHUFFLE(2, 2, 2, 2));
    _mm_store_ss(reinterpret_cast<float*>(&pDestination[2]), z);
#endif
}

_Use_decl_annotations_
inline void MathCallConv StoreInt3A
(
    uint32_t* pDestination,
    VectorArg V
)noexcept{
...
_Use_decl_annotations_
inline void MathCallConv StoreFloat3
(
    Float3* pDestination,
    VectorArg V
)noexcept{
...
_Use_decl_annotations_
inline void MathCallConv StoreFloat3A
(
    AlignedFloat3* pDestination,
    VectorArg     V
)noexcept{
    assert(pDestination);
    assert((reinterpret_cast<uintptr_t>(pDestination) & 0xF) == 0);
...
_Use_decl_annotations_
inline void MathCallConv StoreSInt3
(
    Int3* pDestination,
    VectorArg V
)noexcept{
    ...
    // Write 3 uints
    _mm_store_sd(reinterpret_cast<double*>(pDestination), _mm_castps_pd(vOverflow));
    __m128 z = MATH_PERMUTE_PS(vOverflow, _MM_SHUFFLE(2, 2, 2, 2));
    _mm_store_ss(reinterpret_cast<float*>(&pDestination->z), z);
#endif
}

_Use_decl_annotations_
inline void MathCallConv StoreUInt3
(
    UInt3* pDestination,
    VectorArg V
)noexcept{
    ...
    // Write 3 uints
    _mm_store_sd(reinterpret_cast<double*>(pDestination), _mm_castps_pd(vResult));
    __m128 z = MATH_PERMUTE_PS(vResult, _MM_SHUFFLE(2, 2, 2, 2));
    _mm_store_ss(reinterpret_cast<float*>(&pDestination->z), z);
#endif
}

_Use_decl_annotations_
inline void MathCallConv StoreInt4
(
    uint32_t* pDestination,
    VectorArg V
)noexcept{
...
_Use_decl_annotations_
inline void MathCallConv StoreInt4A
(
    uint32_t* pDestination,
    VectorArg V
)noexcept{
...
_Use_decl_annotations_
inline void MathCallConv StoreFloat4
(
    Float4* pDestination,
    VectorArg  V
)noexcept{
...
_Use_decl_annotations_
inline void MathCallConv StoreFloat4A
(
    AlignedFloat4* pDestination,
    VectorArg     V
)noexcept{
    assert(pDestination);
    assert((reinterpret_cast<uintptr_t>(pDestination) & 0xF) == 0);
...
_Use_decl_annotations_
inline void MathCallConv StoreSInt4
(
    Int4* pDestination,
    VectorArg V
)noexcept{
...
_Use_decl_annotations_
inline void MathCallConv StoreUInt4
(
    UInt4* pDestination,
    VectorArg V
)noexcept{
...
_Use_decl_annotations_
inline void MathCallConv StoreFloat3x4BoundaryRows
(
...
_Use_decl_annotations_
inline void MathCallConv StoreFloat3x4
(
    Float3x4* pDestination,
    FXMMATRIX M
)noexcept{
    // Store the top three affine rows directly. This is the preferred compact
    // boundary format for NWB's column-vector convention.
    StoreFloat3x4BoundaryRows(pDestination, M);
}

_Use_decl_annotations_
inline void MathCallConv StoreFloat3x4ABoundaryRows
(
    AlignedFloat3x4* pDestination,
    FXMMATRIX M
)noexcept{
    assert(pDestination);
    assert((reinterpret_cast<uintptr_t>(pDestination) & 0xF) == 0);
...
_Use_decl_annotations_
inline void MathCallConv StoreFloat3x4A
(
    AlignedFloat3x4* pDestination,
    FXMMATRIX M
)noexcept{
    // Store the top three affine rows directly. This is the preferred compact
    // boundary format for NWB's column-vector convention.
    StoreFloat3x4ABoundaryRows(pDestination, M);
}
