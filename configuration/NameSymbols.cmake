...
function(nwb_add_name_symbol_target)
    ...
    set(_namesym_cook_run "${PROJECT_SOURCE_DIR}/pipeline/launcher.py|||--skip-build|||--tool-directory|||${_namesym_buildmode_bin_dir}|||--repo-root|||${PROJECT_SOURCE_DIR}|||--asset-root|||impl/assets|||--asset-root|||tests/smoke/assets|||--output-directory|||${_namesym_cook_out}|||--cache-directory|||${_namesym_cook_cache}|||--configuration|||$<CONFIG>")
