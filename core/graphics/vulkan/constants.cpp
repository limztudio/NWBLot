...
static constexpr FormatMapping s_FormatMappings[] = {
    ...
    { Format::ASTC_5x4_FLOAT         , VK_FORMAT_ASTC_5x4_SFLOAT_BLOCK_EXT     ,  0, false, false, true  },
    ...
    { Format::ASTC_5x5_FLOAT         , VK_FORMAT_ASTC_5x5_SFLOAT_BLOCK_EXT     ,  0, false, false, true  },
    ...
    { Format::ASTC_6x5_FLOAT         , VK_FORMAT_ASTC_6x5_SFLOAT_BLOCK_EXT     ,  0, false, false, true  },
    ...
    { Format::ASTC_6x6_FLOAT         , VK_FORMAT_ASTC_6x6_SFLOAT_BLOCK_EXT     ,  0, false, false, true  },
    ...
    { Format::ASTC_8x5_FLOAT         , VK_FORMAT_ASTC_8x5_SFLOAT_BLOCK_EXT     ,  0, false, false, true  },
    ...
    { Format::ASTC_8x6_FLOAT         , VK_FORMAT_ASTC_8x6_SFLOAT_BLOCK_EXT     ,  0, false, false, true  },
    ...
    { Format::ASTC_10x5_FLOAT        , VK_FORMAT_ASTC_10x5_SFLOAT_BLOCK_EXT    ,  0, false, false, true  },
    ...
    { Format::ASTC_10x6_FLOAT        , VK_FORMAT_ASTC_10x6_SFLOAT_BLOCK_EXT    ,  0, false, false, true  },
    ...
    { Format::ASTC_8x8_FLOAT         , VK_FORMAT_ASTC_8x8_SFLOAT_BLOCK_EXT     ,  0, false, false, true  },
    ...
    { Format::ASTC_10x8_FLOAT        , VK_FORMAT_ASTC_10x8_SFLOAT_BLOCK_EXT    ,  0, false, false, true  },
    ...
    { Format::ASTC_10x10_FLOAT       , VK_FORMAT_ASTC_10x10_SFLOAT_BLOCK_EXT   ,  0, false, false, true  },
    ...
    { Format::ASTC_12x10_FLOAT       , VK_FORMAT_ASTC_12x10_SFLOAT_BLOCK_EXT   ,  0, false, false, true  },
    ...
    { Format::ASTC_12x12_FLOAT       , VK_FORMAT_ASTC_12x12_SFLOAT_BLOCK_EXT   ,  0, false, false, true  },
};
...
VkPipelineStageFlags2 GetVkPipelineStageFlags(ResourceStates::Mask states, bool rayTracingStageAvailable){
    ...
    if(states & (ResourceStates::ConstantBuffer | ResourceStates::ShaderResource | ResourceStates::UnorderedAccess)){
        // ALL_GRAPHICS omits ray tracing, so add that stage explicitly when its pipeline is enabled.
        // Without this, a UAV/SRV/CB touched by a ray-tracing shader stays unsynchronized against later access.
