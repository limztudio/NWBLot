...
namespace rmv
{
    ...
    public:
        ...
        void RecordNavigationEventPaneSwitch(RMVPaneId pane);
    ...
    signals:
        ...
        void NavigateButtonClicked(rmv::RMVPaneId pane);
    ...
    private:
        ...
        struct NavEvent
        {
            ...
            RMVPaneId pane;  ///< Destination pane.
        };
        ...
        ///
        /// @param [in] pane The new pane.
        void AddNewPaneSwitch(RMVPaneId pane);
        ...
        /// @brief Helper function to convert RMVPaneId enum to string.
        ///
        /// @param [in] pane the pane.
        ///
        /// @return string version of pane name.
        QString GetPaneString(RMVPaneId pane) const;
...
#endif  // RMV_MANAGERS_NAVIGATION_MANAGER_H_
