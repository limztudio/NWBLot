...
#ifndef NWB_ASSETS_MESH_MESHLET_CONSTANTS_H
#define NWB_ASSETS_MESH_MESHLET_CONSTANTS_H
...
#define NWB_MESHLET_UNORM8_MAX 255.0
#define NWB_MESHLET_UNORM8_ROUNDING_BIAS 0.5
