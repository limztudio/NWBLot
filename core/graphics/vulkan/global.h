...
// Primary Graphics/Compute/Transfer, present, and one optional same-class auxiliary family for each class.
inline constexpr usize s_MaxVulkanQueueFamilyKinds = 7u;
