...
public:
    inline void reset(){
        for(auto& i : formatColors)
            i = TextureFormat::UNDEFINED;
        formatDepthStencil = TextureFormat::UNDEFINED;

        numColors = 0;

        opColor = RenderPassOperation::Auto;
        opDepth = RenderPassOperation::Auto;
        opStencil = RenderPassOperation::Auto;
    }

    void addColor(TextureFormat format);


public:
    TextureFormat formatColors[s_maxRenderTargets]{ TextureFormat::UNDEFINED, };
    TextureFormat formatDepthStencil{ TextureFormat::UNDEFINED };

    u8 numColors{ 0 };

public:
    RenderPassOperation opColor{ RenderPassOperation::Auto };
    RenderPassOperation opDepth{ RenderPassOperation::Auto };
    RenderPassOperation opStencil{ RenderPassOperation::Auto };
};
