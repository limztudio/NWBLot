...
- `ab/` holds manually launched A/B measurement workflows; selected workflows also expose parser self-tests to CTest. Raw captures stay local under `.cozter/out/ab-results/`.
