...
namespace __hidden_ecs_world{


////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////


constexpr Name s_WorldTaskProfileName("cpu.task.ecs.world");
...
World::World(Alloc::GlobalArena& arena, CpuTaskScheduler& taskScheduler)
    : m_arena(arena)
    , m_tasks(taskScheduler, taskScheduler.registerProfileLabel(__hidden_ecs_world::s_WorldTaskProfileName))
...
void World::addEntityComponentType(EntityID entityId, ComponentTypeId typeId, IComponentPool& pool){
    ...
    for(u32 nodeIndex = headNode; nodeIndex != s_InvalidEntityComponentNode; nodeIndex = m_entityComponentNodes[nodeIndex].next){
        if(m_entityComponentNodes[nodeIndex].typeId == typeId)
            return;
    }
