...
namespace __hidden_renderer_avboit_resources{
...
bool RendererSystem::createAvboitResources(){
    ...
    if(!__hidden_renderer_avboit_resources::CreateBindingLayout(
        m_arena,
        *device,
...
bool RendererSystem::createAvboitPipelines(){
    ...
    return
        __hidden_renderer_avboit_resources::CreateComputePipeline(
            *device,
