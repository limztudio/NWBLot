...
//
// Preview and commit share one rebuild path (CsgDeformPipeline) so viability
// always agrees. This header preserves the existing include path; domain logic
// lives in deform_types / deform_validator / deform_cutter_field /
// deform_wall_builder / deform_cap_builder / deform_pipeline.
