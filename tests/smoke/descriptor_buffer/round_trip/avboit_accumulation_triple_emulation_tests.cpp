...
// The bounded unsplit Accumulation shared-output path must retain every dispatch/raster alternation. One retained
// generated-vertex buffer therefore crosses Common -> UAV -> VertexBuffer -> UAV -> VertexBuffer -> UAV -> VertexBuffer
// while Pre, the immutable stream, all three pairs, and the attachment finalizer remain one accepted primary-Graphics
// packet. Every callback below is getter-only: state probes, one Pre timing ticket, and accepted-token equality are the contract.
TEST_F(DescriptorBufferRoundTripTest, GraphOwnedUnsplitAvboitAccumulationSharedOutputComputeEmulationTriplesStayInPrePacket){
    ...
    auto generatedVertex = createWorkBuffer(
        Name("tests/descriptor_buffer/unsplit_avboit_accumulation_shared_output_triple_generated_vertex"),
        true
    );
    ...
    const GpuGraphResourceId accumColorResource = importTexture(
        accumColor,
        Name("tests/descriptor_buffer/unsplit_avboit_accumulation_shared_output_triple_color"),
        "AVBOIT Accumulation Shared Output Color"
    );
    const GpuGraphResourceId accumExtinctionResource = importTexture(
        accumExtinction,
        Name("tests/descriptor_buffer/unsplit_avboit_accumulation_shared_output_triple_extinction"),
        "AVBOIT Accumulation Shared Output Extinction"
    );
    const GpuGraphResourceId deferredDepthResource = importTexture(
        deferredDepth,
        Name("tests/descriptor_buffer/unsplit_avboit_accumulation_shared_output_triple_depth"),
    ...
    const GpuTaskId preTask = graph.addTask<NativePacketAsyncAvboitExtinctionLifecycleTask>(
        GpuTaskDesc{}
            .setIdentity(Name("tests/descriptor_buffer/unsplit_avboit_accumulation_shared_output_triple_pre_task"))
    ...
    const GpuTaskId streamTask = graph.addTask<NativePacketAsyncAvboitExtinctionLifecycleTask>(
        GpuTaskDesc{}
            .setIdentity(Name("tests/descriptor_buffer/unsplit_avboit_accumulation_shared_output_triple_material_upload_task"))
    ...
    const Name sharedPhaseIdentities[] = {
        Name("tests/descriptor_buffer/unsplit_avboit_accumulation_shared_output_triple_dispatch_a_task"),
        Name("tests/descriptor_buffer/unsplit_avboit_accumulation_shared_output_triple_raster_a_task"),
        Name("tests/descriptor_buffer/unsplit_avboit_accumulation_shared_output_triple_dispatch_b_task"),
        Name("tests/descriptor_buffer/unsplit_avboit_accumulation_shared_output_triple_raster_b_task"),
        Name("tests/descriptor_buffer/unsplit_avboit_accumulation_shared_output_triple_dispatch_c_task"),
        Name("tests/descriptor_buffer/unsplit_avboit_accumulation_shared_output_triple_raster_c_task"),
    };
    ...
    finalizerPayload.expectedOrdinal = 8u;
    ...
    const GpuTaskId finalizerTask = graph.addTask<NativePacketAsyncAvboitExtinctionLifecycleTask>(
        GpuTaskDesc{}
            .setIdentity(Name("tests/descriptor_buffer/unsplit_avboit_accumulation_shared_output_triple_finalize_task"))
    ...
    Alloc::ScratchArena scratchArena(Name("tests/descriptor_buffer/unsplit_avboit_accumulation_shared_output_triple_lifecycle_scratch"));
    ...
    EXPECT_TRUE(analysis.hasExplicitEdge(rasterCTask, finalizerTask));
    ...
    EXPECT_TRUE(analysis.hasInferredEdge(rasterCTask, finalizerTask));
    ...
    EXPECT_EQ(analysis.topologicalOrder()[8u], finalizerTask);
    ...
    // same accepted Graphics token, including all three shared-output dispatch/raster pairs and the finalizer.
