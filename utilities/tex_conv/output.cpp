...
AString BuildMetadata(const TexturePayload& payload, const Path& dataPath, const bool srgb){
    ...
    output
        ...
        << s_NewLine
        << "asset.version = " << s_TextureMetadataVersion << ";" << s_NewLine
        << "asset.format = \"" << s_UastcLdr4x4Format << "\";" << s_NewLine
        << "asset.uastc_spec_revision = \"" << s_UastcSpecificationRevision << "\";" << s_NewLine
        << "asset.color_space = \"" << (srgb ? s_SrgbColorSpace : s_LinearColorSpace) << "\";" << s_NewLine
