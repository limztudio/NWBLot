...
require_match("${bunch_text}" "\"base\": \\{" "asset bunch model did not emit a static mesh object map:\n${bunch_text}")
require_match("${bunch_text}" "\"mesh\": mesh" "asset bunch model did not reference its child mesh variable:\n${bunch_text}")
...
require_match("${model_text}" "\"base\": \\{" "model package did not emit a static mesh object map:\n${model_text}")
