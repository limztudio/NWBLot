...
inline constexpr const char* s_GpuDetectiveCaptureFileName = "gpu_crash.rgd"; // canonical in-package AMD Radeon GPU Detective capture (decoded server-side via rgd.exe when present)
