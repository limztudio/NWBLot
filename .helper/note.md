...
61. Mesh material typed payloads use `g_NwbMaterialTypedWords` at binding 13 through `impl/assets/graphics/mesh/runtime.slangi` and generated `.bind` accessors. Bindings 5 and 6 are meshlet data, not material typed data.
