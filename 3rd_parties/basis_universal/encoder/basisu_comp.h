...
// NWB modification: exposes raw UASTC backend slices for utilities/tex_conv.
#pragma once
...
namespace basisu
{
	...
	public:
		...
		// Raw per-slice blocks emitted by the UASTC encoder. This is intentionally exposed
		// for tex_conv, which writes a bare UASTC block stream instead of a .basis container.
		const basisu_backend_output& get_uastc_backend_output() const { return m_uastc_backend_output; }
