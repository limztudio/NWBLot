...
inline constexpr StringView s_GpuDetectiveCaptureFileName = "gpu_crash.rgd"; // in-package AMD RGD capture (decoded server-side)
inline constexpr StringView s_AftermathGpuDumpFileName = "gpu_crash.nv-gpudmp"; // in-package NVIDIA Aftermath dump (decoded server-side when present)
